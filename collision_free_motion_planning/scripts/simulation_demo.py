...
def main():
    ...
    add_collision_obj("washer", [2.0, 0.0, 1.5, 0.0, 0.0, -0.707, 0.707], "../collision_objects/complete_washer.stl")
    ...
    add_collision_obj("filling_basket_1", [0.0, 1.35, 0.6, 0.707, 0.0, 0.0, 0.707], "../collision_objects/basket_collision.stl")
    # add_collision_obj("filling_basket_2", [0.0, 0.735, 0.6, 0.707, 0.0, 0.0, 0.707], "../collision_objects/basket_collision.stl")
    # add_collision_obj("filling_basket_3", [0.0, -0.735, 0.6, 0.707, 0.0, 0.0, 0.707], "../collision_objects/basket_collision.stl")
    # add_collision_obj("filling_basket_4", [0.0, 1.965, 1.07, 0.707, 0.0, 0.0, 0.707], "../collision_objects/basket_collision_three_faces.stl")
    ...
    # reach_base_state([0.0, 0.0])
    # input("Add baskets to the planning scene.")
    # add_collision_obj("retrieving_basket", [0.51, -1.36, 0.8, 0.0, 0.707, 0.707, 0.0], "../collision_objects/basket_collision.stl")
...
def check_box_pose():
    ...
    input("1")
    add_collision_obj("filling_basket", box_pos[:3].tolist()+[0.707, 0.0, 0.0, 0.707], "../collision_objects/basket_collision.stl")
    input("2")
